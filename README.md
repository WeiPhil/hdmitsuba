...
2.  **Dependencies**:
    ...
    *   **Mitsuba 3**: Locally built from source. Similarly to USD, it is not included as a submodule. For compatibility, it is recommended to use commit [`7dc46159`](https://github.com/mitsuba-renderer/mitsuba3/commit/7dc4615957cbcfe6c57100373b9d6da8ff656d94) (which is the version validated in our CI configuration). The `pip`-installed version of Mitsuba currently is not supported.
